    ...
    <div className="h-80 w-full">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 20, right: 20, left: -20, bottom: 0 }}>
          ...
          <Legend />
          <Area type="monotone" dataKey="incoming" stroke="#22c55e" fillOpacity={1} fill="url(#incoming)" />
          <Area type="monotone" dataKey="outgoing" stroke="#f97316" fillOpacity={1} fill="url(#outgoing)" />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
